...
from ..features.search.routes.searchRoute import SearchRoute, SearchES
...
def load_config_routes(app):
    ...
    app.add_url_rule("/api/v1/universityService/searchES",
                     view_func=SearchES.as_view("searchES_api"))
